  ...
  return (
    ...
    >
      {data.length ? (
        <Stack spacing={2}>
          {data.map((order) => (
            <Card key={order.id} sx={{ borderRadius: 1 }}>
              <CardContent>
                <Stack
        ...
        <EmptyState
          description="Order tracking is connected to your account. Your purchases will appear here as soon as orders are placed."
          title="Orders will be available soon"
        />
      )}
    </PageSection>
  );
